...
class AlternatifController extends Controller
{
    ...
    {
        $data = new Alternatif();
        $data->nmalternatif = $request->nmalternatif;
        $data->harga= $request->harga;
        $data->jenis_prosesor = $request->jenis_prosesor;
        $data->kapasitas_memori= $request->kapasitas_memori;
        $data->tipe_memori = $request->tipe_memori;
        $data->kapasitas_harddisk = $request->kapasitas_harddisk;
        $data->ukuran_layar = $request->ukuran_layar;
        $data->save();
